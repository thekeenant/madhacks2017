...
import com.midevilgame.entity.Attachment;
...
public class Game implements ApplicationListener {
	...
	public void create() {
		...
		currentMap.addEntity(new Player(currentMap, Textures.CHARACTER, new Vector2(), 16, 16));
	...
	private void handleInput() {
		...
		System.out.println(currentMap.getPlayer().getCenter());
